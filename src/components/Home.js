              ...
              <Row>
                ...
                <Col sm={5} className="right_text">
                    <h2 className="subtitle">
                        ...
                        <br/>Js Frameworks & API Accessing                     
                    </h2>
                     <p>As you know, javascript is becoming most important in today webdevelopment, I am filling my js skills every time for development.</p>
                </Col>      
              </Row>       
            </Grid>             
        ...
        <div className="subsection learning">
            <Row>
                <Col sm={4}>
                  ...
                  <img src={require("../assets/images/backbone.png")} alt="backbonelearning"/>
                  <h4>Hotel Lists By Backbone.js</h4>
                  <p>
                    This is my backbone learing tutorial.<br/>
                    e-book : backbone-fundamentals by Addy Osmani<br/>
                ...
                <Col sm={4}>
            		<a href="https://shinphoowin.github.io/reactform/">
                        <img src={require("../assets/images/logo.svg")} alt="backbonelearning"/>                  
                ...
                <Col sm={4}>
                    ...
                    <img src={require("../assets/images/logo.svg")} alt="reactleraning"/>
